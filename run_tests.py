...
def run_pytest_tests(test_type="all", coverage=True, verbose=True, html_report=True):
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Biomedical Assistant Test Runner")
    parser.add_argument(
        "--type", 
        choices=["all", "unit", "integration", "performance", "stress", "fast"],
        default="all",
    ...
    if success:
        ...
        print(f"   HTML Report: {'Enabled' if not args.no_html else 'Disabled'}")
