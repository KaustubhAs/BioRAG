...
def sample_data():
    ...
    return {
        ...
        'relationships': [
            {'source': 'Diabetes', 'target': 'Fever', 'type': 'HAS_SYMPTOM'},
            {'source': 'Diabetes', 'target': 'Fatigue', 'type': 'HAS_SYMPTOM'},
            {'source': 'Hypertension', 'target': 'Headache', 'type': 'HAS_SYMPTOM'},
            {'source': 'Hypertension', 'target': 'Chest Pain', 'type': 'HAS_SYMPTOM'},
            {'source': 'Malaria', 'target': 'Fever', 'type': 'HAS_SYMPTOM'},
            {'source': 'Malaria', 'target': 'Headache', 'type': 'HAS_SYMPTOM'}
        ]
    }
